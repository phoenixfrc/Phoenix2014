...
#define PHOENIX2014_VOLTAGE_AT_VERTICAL 2.51
#define PHOENIX2014_VOLTAGE_AT_FRONT 0.65
#define PHOENIX2014_VOLTAGE_AT_BACK 4.05
//Constants for grabber
#define PHOENIX2014_LOOP_COUNT_FOR_SHOOT_DELAY 30
